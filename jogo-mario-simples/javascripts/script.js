...
function teclaPressionada(event) {
  if (event.key === "ArrowRight") {
    ...
    personagem.style.backgroundImage =
      "url(/imagens/marioAndandoLadoDireito.gif)";
  } else if (event.key === "ArrowLeft") {
    direcao = -1;
    personagem.style.backgroundImage =
      "url(/imagens/marioAndandoLadoEsquerdo.gif)";
...
function teclaSolta(event) {
  if (event.key === "ArrowRight") {
    direcao = 0;
    personagem.style.backgroundImage =
      "url(/imagens/marioParadoLadoDireito.png)";
  } else if (event.key === "ArrowLeft") {
    direcao = 0;
    personagem.style.backgroundImage =
      "url(/imagens/marioParadoLadoEsquerdo.png)";
  }
}
...
function colisaoComBloco() {
  ...
  if (
    ...
    audioMoeda.play();
    checarMoedas();
    bloco.style.top = "516px";
    setTimeout(() => {
      bloco.style.top = "536px";
    }, 90);
    setTimeout(() => {
